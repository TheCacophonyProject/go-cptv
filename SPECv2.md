...
|BackgroundFrame| 1        | 'g'   | uint8 | Number of background frames in this file. In practise we are only
...
checking this value is non zero, one should only expect a single background frame when reading a CPTV file
